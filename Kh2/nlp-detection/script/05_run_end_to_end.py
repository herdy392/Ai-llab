...
Runs out-of-the-box in rule mode (no models needed):
  python script/05_run_end_to_end.py --input data-input/kh2_corpus.txt
Upgrade with the trained verifier:
  python script/05_run_end_to_end.py --input my.txt --verifier-model models/kh2_verifier/best_model
...
def main():
    ...
    # NER (models/kh2_ner/best_model) can replace detect_mentions for noisier text.
