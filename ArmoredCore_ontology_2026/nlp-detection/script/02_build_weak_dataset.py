...
grounded by domain/range) and emits, mirroring the professor's weak dataset:
  - generated/ac6_sentences_all.jsonl
  - generated/ac6_relation_candidates_{all,train,val,test}.jsonl   ([E1]/[E2] + candidate_relation)
  - generated/ac6_ner_{train,val,test}.jsonl                       (BIO token classification)
  - generated/ac6_weak_stats.json
...
wj(GEN / "ac6_sentences_all.jsonl", sentence_rows)
wj(GEN / "ac6_relation_candidates_all.jsonl", relation_rows)
for sp in ("train", "val", "test"):
    wj(GEN / f"ac6_relation_candidates_{sp}.jsonl", [r for r in relation_rows if r["split"] == sp])
    wj(GEN / f"ac6_ner_{sp}.jsonl", [r for r in ner_rows if r["split"] == sp])
...
(GEN / "ac6_weak_stats.json").write_text(json.dumps(stats, indent=2, ensure_ascii=False), encoding="utf-8")
