...
Solo standard library + ac6_lib. Importato da 11_export_results_data.py.
"""
...
def dataset_split_table(gen_dir, out_csv, out_md=None):
    ...
    for split in ["train", "val", "test"]:
        rows = _load(gen_dir / f"ac6_verifier_{split}.jsonl")
...
def extraction_summaries(gen_dir, out_csv=None):
    ...
    gen_dir = Path(gen_dir)
    gold = gen_dir / "ac6_instance_triples.jsonl"
    systems = []
